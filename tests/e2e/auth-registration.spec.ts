...
test.describe('User Registration with Email/Password', () => {
  ...
  test(
    'should display error for weak password',
    {
  ...
  test(
    'should display error for password mismatch',
    {
  ...
  test(
    'should display error for duplicate email registration',
    {
...
test.describe('Social Login - Google OAuth', () => {
  test(
    'should successfully authenticate via Google OAuth',
    {
  ...
  test(
    'should display error when Google OAuth fails',
    {
...
test.describe('Social Login - GitHub OAuth', () => {
  test(
    'should successfully authenticate via GitHub OAuth',
    {
  ...
  test(
    'should handle OAuth account linking for existing email',
    {
...
test.describe('Authentication Rate Limiting', () => {
  test(
    'should enforce rate limit after excessive login attempts',
    {
