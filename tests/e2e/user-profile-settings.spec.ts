...
test.describe('User Profile Settings Page', () => {
  ...
  test(
    'should load current user profile data on page load',
    {
...
test.describe('Preferred AI Tools Management', () => {
  test(
    'should add new AI tool to preferred list',
    {
  ...
  test(
    'should remove AI tool from preferred list',
    {
  ...
  test(
    'should prevent removing all AI tools',
    {
  ...
  test(
    'should save AI tools changes to backend',
    {
...
test.describe('Notification Preferences', () => {
  test(
    'should toggle email notifications on/off',
    {
  ...
  test(
    'should toggle in-app notifications on/off',
    {
  ...
  test(
    'should configure quiet hours for notifications',
    {
  ...
  test(
    'should validate quiet hours time range',
    {
  ...
  test(
    'should save notification preferences to backend',
    {
