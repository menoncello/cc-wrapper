...
test.describe('Onboarding Step 1 - User Type Selection', () => {
  test(
    'should display three user type options',
    {
  ...
  test(
    'should disable Next button until user type is selected',
    {
...
test.describe('Onboarding Step 2 - AI Tools Selection', () => {
  test(
    'should display available AI tools with checkboxes',
    {
  ...
  test(
    'should allow multiple AI tool selections',
    {
  ...
  test(
    'should allow proceeding with no AI tools selected',
    {
...
test.describe('Onboarding Step 3 - Workspace Configuration', () => {
  test(
    'should validate required workspace name',
    {
  ...
  test(
    'should display workspace template options',
    {
  ...
  test(
    'should create workspace with selected template',
    {
