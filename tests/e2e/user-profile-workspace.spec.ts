...
test.describe('Default Workspace Selection', () => {
  test(
    'should display list of available workspaces in dropdown',
    {
  ...
  test(
    'should change default workspace selection',
    {
  ...
  test(
    'should save default workspace preference to backend',
    {
  ...
  test(
    'should display default workspace name on dashboard',
    {
...
test.describe('Profile Update Validation', () => {
  ...
  test(
    'should disable save button while save is in progress',
    {
  ...
  test(
    'should discard changes when cancel button is clicked',
    {
