...
describe('OnboardingStore - User Type', () => {
  beforeEach(() => {
    // Reset store to initial state before each test
    useOnboardingStore.getState().reset();
  });
...
describe('OnboardingStore - AI Tools', () => {
  beforeEach(() => {
    // Reset store to initial state before each test
    useOnboardingStore.getState().reset();
  });
...
describe('OnboardingStore - Workspace Configuration', () => {
  beforeEach(() => {
    // Reset store to initial state before each test
    useOnboardingStore.getState().reset();
  });
...
describe('OnboardingStore - Validation', () => {
  beforeEach(() => {
    // Reset store to initial state before each test
    useOnboardingStore.getState().reset();
  });
