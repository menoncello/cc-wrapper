...
- **DEV agent** enforces zero-tolerance quality standards
- **Fix root causes** instead of disabling rules
- **All code examples** in stories/ADRs must compile
- **Review workflow** scans for policy violations
